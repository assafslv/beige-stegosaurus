...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/60511ff574fe200016f7413e
...
To start editing your site, you can use the Sanity interface at https://beige-stegosaurus-11ff5.sanity.studio/.
...
Generated at `2021-03-16T21:22:37.620Z` by Stackbit version `0.3.50`.